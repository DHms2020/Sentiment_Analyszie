...
import torch
from LSTM_attention import Model
import os
...
PAD_IDX = 25001
# 配置tensorboard输出路径
Tensorboard_LSTM_path = "LSTM_attention_tensboard"
...
if __name__ == "__main__":
    ...
    model = Model(vocab_size=INPUT_DIM, embedding_dim=EMBEDDING_DIM, hidden_dim=HIDDEN_DIM, num_class=OUTPUT_DIM,
                  n_layers=N_LAYERS, dropout_rate=DROPOUT, pad_idx=PAD_IDX)
    ...
    torch.save(model.state_dict(), './models/LSTM_attention_para.pth')
